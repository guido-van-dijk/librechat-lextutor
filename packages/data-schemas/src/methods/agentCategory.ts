...
export function createAgentCategoryMethods(mongoose: typeof import('mongoose')) {
  ...
  async function ensureDefaultCategories(): Promise<boolean> {
    ...
    const defaultCategories = [
      {
        value: 'language_arts',
        label: 'com_agents_category_language_arts',
        description: 'com_agents_category_language_arts_description',
        order: 0,
      },
      {
        value: 'mathematics',
        label: 'com_agents_category_mathematics',
        description: 'com_agents_category_mathematics_description',
        order: 1,
      },
      {
        value: 'science',
        label: 'com_agents_category_science',
        description: 'com_agents_category_science_description',
        order: 2,
      },
      {
        value: 'social_studies',
        label: 'com_agents_category_social_studies',
        description: 'com_agents_category_social_studies_description',
        order: 3,
      },
      {
        value: 'arts_creative',
        label: 'com_agents_category_arts_creative',
        description: 'com_agents_category_arts_creative_description',
        order: 4,
      },
      {
        value: 'technology_engineering',
        label: 'com_agents_category_technology_engineering',
        description: 'com_agents_category_technology_engineering_description',
        order: 5,
      },
    ];
